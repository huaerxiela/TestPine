 ...
 */
public final class HposedHelpers {
	private HposedHelpers() {}
	...
	public static Class<?> findClass(String className, ClassLoader classLoader) {
		if (classLoader == null)
			classLoader = HposedBridge.BOOTCLASSLOADER;
		try {
	 ...
	 * for details.
	 */
	public static HC_MethodHook.Unhook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
		if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length-1] instanceof HC_MethodHook))
			throw new IllegalArgumentException("no callback defined");

		HC_MethodHook callback = (HC_MethodHook) parameterTypesAndCallback[parameterTypesAndCallback.length-1];
		Method m = findMethodExact(clazz, methodName, getParameterClasses(clazz.getClassLoader(), parameterTypesAndCallback));

		return HposedBridge.hookMethod(m, callback);
	}
	 ...
	 * an anonymous subclass of {@link HC_MethodHook} or {@link HC_MethodReplacement}.
	 *
	 * <p><b>Example</b>
	 ...
	 */
	public static HC_MethodHook.Unhook findAndHookMethod(String className, ClassLoader classLoader, String methodName, Object... parameterTypesAndCallback) {
	...
	private static Class<?>[] getParameterClasses(ClassLoader classLoader, Object[] parameterTypesAndCallback) {
		...
		for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
			...
			if (type instanceof HC_MethodHook)
				continue;
	 ...
	 * for details.
	 */
	public static HC_MethodHook.Unhook findAndHookConstructor(Class<?> clazz, Object... parameterTypesAndCallback) {
		if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length-1] instanceof HC_MethodHook))
			throw new IllegalArgumentException("no callback defined");
	 ...
	 * for details.
	 */
	public static HC_MethodHook.Unhook findAndHookConstructor(String className, ClassLoader classLoader, Object... parameterTypesAndCallback) {
